...
<html lang="en">
    ...
    <body>
        ...
        <div class="about">
            ...
            <br/><br/><br/><br/><br/>
            <h2><span>|</span> Our Board of Director</h2>
            <div class="image">
                <div class="row">
                    <div class="col-sm-2">
                        <img src="{{URL::asset('/images/about/ceo.svg')}}" alt="profile Pic" height="188" width="188">
                        <h5>CEO</h5>
                        <h6>Jhon Doe</h6>
                    </div>
                    <div class="col-sm-2">
                        <img src="{{URL::asset('/images/about/coo.svg')}}" alt="profile Pic" height="188" width="188">
                        <h5>COO</h5>
                        <h6>Jhon Doe</h6>
                    </div>
                    <div class="col-sm-2">
                        <img src="{{URL::asset('/images/about/cto.svg')}}" alt="profile Pic" height="188" width="188">
                        <h5>CTO</h5>
                        <h6>Jhon Doe</h6>
                    </div>
                    <div class="col-sm-2">
                        <img src="{{URL::asset('/images/about/cmo.svg')}}" alt="profile Pic" height="188" width="188">
                        <h5>CMO</h5>
                        <h6>Jhon Doe</h6>
                    </div>
                    <div class="col-sm-2">
                        <img src="{{URL::asset('/images/about/cfo.svg')}}" alt="profile Pic" height="188" width="188">
                        <h5>CFO</h5>
                        <h6>Jhon Doe</h6>
                    </div>
                </div>
