        ...
        <div id="page-content-wrapper">
            ...
            <div class="container-fluid px-4">
                ...
                <div class="main-content row my-4">
                    ...
                    <div class="col-6 row">
                        <h3 class="fs-4 mb-4 second-text fw-bold">You already have the team</h3>
                        <div class="col-3">
                            <img src="images/feelsbox.png" alt="" width="80" class="col">
                        </div>
                        <div class="col">
                            <p class="text-title col">Feelsbox merupakan platform layanan kesehatan mental untuk usia remaja. Layanan kami meliputi konseling, mentoring, self-tracking, hingga coaching</p>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="col">
                        ...
                        <div class="card-content row row-cols-1 row-cols-md-3 g-4">
                            ...
                            <div class="col justify-content-center text-center">
                              <div class="card">
                                <div class="card-body">
                                    <img class="card-image rounded-circle article-img" src="images/.jpeg" id="">
                                    <h5 class="card-title fw-bold fs-6">Bagus Satrio</h5>
                                    <p class="card-text">Hacker</p>
                                </div>
                              </div>
                            </div>
